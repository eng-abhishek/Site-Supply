...
input::-webkit-inner-spin-button {
 ...
 <div class="row lego-row buttons-top" style=" text-align:center;margin-left:-20px !important;margin-top:0px">
            ...
            <div class="col-lg-2half" style="background-color:#E5E5E5;padding:10px 0px 10px 0px;font-size:0.9em;font-weight:600;
           ...
           <div class="col-lg-2half" class="table-img" style="background-color:#ffff;
            ...
            <div class="col-lg-2half" style="background-color:#ffff; color:EA9418;
        ...
        @endif  
            ...
            <div class="col-6 text-center">
             ...
             @endforeach
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 text-right" style="margin-top: 10px; left:45px;margin-bottom:40px">
