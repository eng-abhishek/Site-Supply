...
.community {
 ...
 <div class="row buttons-top" style=" text-align:center;margin-left:-20px !important;margin-top:0px">
           ...
           <button style="padding:5px 20px 5px 20px;border:none;outline:none;
             ...
             <div class="row lego-row buttons-bot" style="display:none">
               ...
               @foreach($product as $productData)
                   ...
                   <div class="row text-center" style="width:90%;margin:auto;background-color:#F3F2F2;margin-bottom:10px;padding-bottom:15px;margin-left:60px" >
            ...
            <div class="col-6 text-center">
             ...
             <div class="col-6 text-left">
              ...
              <h6 style="font-weight: 600;padding-top:3px"> PRICE (Per Piece)</h6>
            ...
            <div class="col-6 text-center">
               ...
               <input placeholder="0" type="number" value="" name="pro_qty" id="pro_qty{{$productData->id}}" onkeyup="add_to_cart(<?php echo $productData->id;?>,<?php echo $productData->qty_id;?>,<?php echo $productData->price_id;?>)" style="width: 55%; padding-left:0px;background-color:#F7F5F5;border-radius:4px;border:none;height:24px;text-align: center;"> 
            ...
            <div class="col-6 text-center">
             ...
             @endforeach
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 text-right" style="margin-top: 10px; left:34px;margin-bottom:40px">
