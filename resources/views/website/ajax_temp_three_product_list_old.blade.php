 ...
 <div class="row lego-row buttons-top" style=" text-align:center;margin-left:-20px !important;margin-top:0px">
         ...
         INR <font id="totalAmt"></font>
           ...
           <button style="padding:5px 20px 5px 20px;border:none;outline:none;
             ...
             <div class="row lego-row buttons-bot" style="display:none;margin-left:60px !important">
               ...
               @foreach($product as $productData)
                   ...
                   <div class="text-center" style="width:90%;margin:auto;background-color:#F3F2F2;margin-bottom:10px;padding-bottom:15px;margin-left:60px !important" >
