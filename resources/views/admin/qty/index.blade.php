            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a href="{{url('quantity-add')}}" style="float: right"><button class="btn btn-info"><i class="fa fa-plus"></i>Add Quantity</button></a> 
                </div><!-- /.box-header -->
                <div class="box-body">
...
<td>                  
                        <a href="{{url("quantity-edit/$categoryval->id")}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                        <a data-id="{{$categoryval->id}}" href="{{url("quantity-destroy/$categoryval->id")}}" class="btn btn-danger delete-confirm"><i class="fa fa-trash"></i></a>                
</td>
                      </tr>
                      @endforeach
                    </tbody>
...
function updateCategoryStatus(id){
 ...
 $.ajax({
 url:"{{url('update-quantity-status')}}",
 method:'post',
