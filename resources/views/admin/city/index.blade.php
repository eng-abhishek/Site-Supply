            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a href="{{url('city-add')}}" style="float: right"><button class="btn btn-info"><i class="fa fa-plus"></i>Add City</button></a> 
                </div><!-- /.box-header -->
                <div class="box-body">
...
<td>                  
                        <a href="{{url("city-edit/$categoryval->id")}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                       <a href="{{url("city-destroy/$categoryval->id")}}" class="btn btn-danger delete-confirm"><i class="fa fa-trash"></i></a>    
</td>
