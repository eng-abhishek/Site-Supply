...
?>
<img src="{{asset('uploads/productCategory/'.$categoryval->img)}}" width="50px">
<?php
}?>
...
<td>                  
                        ...
                        <a href="{{url("category-destroy/$categoryval->id")}}" class="btn btn-danger delete-confirm"><i class="fa fa-trash"></i></a>                
</td>
