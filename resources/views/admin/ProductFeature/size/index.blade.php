...
@section('title','View Size Feature')
@section('content')
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Product Size List</h3>
                  <a href="{{url('size-add')}}" style="float: right"><button class="btn btn-info"><i class="fa fa-plus"></i>Add Size</button></a> 
                </div><!-- /.box-header -->
                <div class="box-body">
...
<td>                  
                        <a href="{{url("size-edit/$categoryval->id")}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                        <a href="{{url("size-destroy/$categoryval->id")}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>                
</td>
