...
@section('title','View Brand Feature')
@section('content')
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a href="{{url('brand-add')}}" style="float: right"><button class="btn btn-info"><i class="fa fa-plus"></i>Add Brand</button></a> 
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
<?php if(empty($categoryval->logo)){
?>
<img src="{{asset('assets/front-end/img/default-img.png')}}" width="50px">
<?php
}else{
?>
<img src="{{asset('uploads/brandLogo/'.$categoryval->logo)}}" width="50px">
<?php
}?>
...
<td>                  
                        <a href="{{url("brand-edit/$categoryval->id")}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                        <a href="{{url("brand-destroy/$categoryval->id")}}" class="btn btn-danger delete-confirm"><i class="fa fa-trash"></i></a>                
</td>
