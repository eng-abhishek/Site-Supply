...
@section('title','Add Best Selling')
@section('content')
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Best Selling</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" id="testimonialForm" action="{{url('store-best-seller')}}" enctype="multipart/form-data">
                  <div class="box-body">
...
if(chkLength==8 || chkLength==12){
return true;
}else{
alert('Please Select Eigth or Twelve Product');
return false; 
}
