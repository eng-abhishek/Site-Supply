    ...
    <!--       <div class="col-md-1"></div> -->
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" id="category-store" action="{{url('testimonial-store')}}" enctype="multipart/form-data">                 
                  <div class="box-body">
                     ...
                     @csrf
                      ...
                      <input type="test" class="form-control" name="designation" id="designation" required="">
                      @error('designation')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <textarea class="form-control ckeditor" name="des" id="des" required=""></textarea>
                      @error('des')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
